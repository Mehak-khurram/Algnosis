...
// type ReportStatus = "In Review" | "Completed";
...
//             const token = localStorage.getItem('token');
//             fetch(`http://localhost:17000/doctor/get/${report.doctorID}`, {
//                 headers: {
...
//                                     <img
//                                         src={imageUrl}
//                                         alt={report?.fileName || "Chest X-ray"}
...
//                                 <div className={`flex flex-col items-center justify-center py-4 rounded-xl ${status === "Completed" ? "bg-green-50" : "bg-yellow-50"}`}>
//                                     {status === "Completed" ? (
...
//                                     )}
//                                     <div className={`text-xl font-bold ${status === "Completed" ? "text-green-700" : "text-yellow-700"}`}>{status}</div>
...
//                                 <div className="mt-6 flex-1 flex flex-col justify-center h-96">
...
//                                             return (
//                                                 <div key={idx} className="relative z-10 flex items-center w-full mb-12 last:mb-0" style={{ minHeight: 64 }}>
//                                                     <div className="flex flex-col items-center mr-4">
//                                                         <div className={`w-10 h-10 rounded-full flex items-center justify-center border-4 transition-all duration-500 ${isActive ? "bg-blue-600 border-blue-400" : "bg-gray-300 border-gray-200"} ${isCurrent ? "animate-pulse" : ""}`}>
//                                                             {isActive ? <CheckCircle className="w-6 h-6 text-white" /> : <Clock className="w-6 h-6 text-gray-400" />}
//                                                         </div>
//                                                         {idx < 2 && <div className={`w-1 h-12 ${isActive ? "bg-blue-400" : "bg-gray-200"} transition-all duration-500`} />}
//                                                     </div>
//                                                     <div className="flex-1">
//                                                         <div className="text-gray-800 font-medium">{step.label}</div>
...
//                     <div className="lg:col-span-2">
//                         <div className={`bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden h-full transition-all duration-500 ${status !== "Completed" ? "opacity-60 grayscale" : "opacity-100"}`}>
//                             <div className="bg-gradient-to-r from-blue-50 to-indigo-50 px-6 py-4 border-b">
//                                 <h2 className="text-xl font-semibold text-gray-800 flex items-center">
